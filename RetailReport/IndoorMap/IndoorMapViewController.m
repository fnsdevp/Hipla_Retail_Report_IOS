        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            for (int i = 0; i < path.count; i++ ) {
                ...
                if(i == 0) {
                    ...
                    _custom = [[UIImageView alloc] initWithFrame:CGRectMake(xPoint, yPoint, 20, 20)];
                    _custom.backgroundColor = [UIColor yellowColor];
                    _custom.layer.cornerRadius = _custom.frame.size.height/2.f;
                    
                    [_imageView addSubview:_custom];
                }
            }
            //    }
