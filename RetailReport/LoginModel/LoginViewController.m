...
//
////    ProductCategoryViewController *productViewScreen = [[ProductCategoryViewController alloc] init];
...
//        NSString *userUpdate = @{@"username":self.txtEmail.text,@"password":self.txtPassword.text,@"deviceId":deviceToken,@"dtype":@"iOS"};
    ...
    NSString *userUpdate = [NSString stringWithFormat:@"email=%@&password=%@&regkey=%@&device_type=ios",[NSString stringWithFormat:@"%@", self.txtEmail.text],[NSString stringWithFormat:@"%@",self.txtPassword.text],deviceToken];
...
//    [api ApiRequestPOSTwithParameters:params WithUrlLastPart:@"login.php" completion:^(NSDictionary * dict, NSError *error) {
    ...
    [api ApiRequestPOSTwithPostdata:data WithUrlLastPart:@"sales_login.php" completion:^(NSDictionary * dict, NSError *error) {
        ...
        if (!error) {
            ...
            if ([successStr isEqualToString:@"success"]) {
                ...
                if ([productCategory count]>0) {
                    ...
                    NSDictionary *ProfDict = [NSDictionary dictionaryWithDictionary: [productCategory objectAtIndex:0]];
...
-(void)gotoHome
{
    ScanForBillViewController *homeVc = [[ScanForBillViewController alloc]initWithNibName:@"ScanForBillViewController" bundle:nil];
