...
//    [api ApiRequestPOSTwithParameters:params WithUrlLastPart:@"register.php" completion:^(NSDictionary * dict, NSError *error) {
    [api ApiRequestPOSTwithPostdata:data WithUrlLastPart:@"sales_register.php" completion:^(NSDictionary * dict, NSError *error) {
